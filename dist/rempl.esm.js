const { connectPublisherWs, createEnv, createPublisher, createSandbox, getEnv, getHost, getSelfSubscriber, getSubscriber, scriptFromFile, version } = function rempl() {
...
//# sourceURL=${sourceURL}`)();
  ...
  function createSandbox2(settings2, callback) {
  ...
  function createPublisher2(id, getRemoteUI, options) {
  ...
  function connectPublisherWs2(uri) {
  ...
  function getSelfSubscriber2(id) {
  ...
  function scriptFromFile2(filename, includeRempl = false) {
    let cache = null;
  ...
  ;
  return {
    connectPublisherWs: connectPublisherWs2,
    createEnv: createEnv2,
    createPublisher: createPublisher2,
    createSandbox: createSandbox2,
    getEnv: getEnv2,
    getHost: getHost2,
    getSelfSubscriber: getSelfSubscriber2,
    getSubscriber: getSubscriber2,
    scriptFromFile: scriptFromFile2,
    version: version2
  };
}();
export {
