...
function createSandbox(endpoint, options) {
    ...
    var publisherConnected = new Expression(publisherExists, sessionOpenned, function (
        publisherExists,
        sessionOpenned
    ) {
...
module.exports = new Node({
    ...
    syncUI: function () {
        ...
        if (this.data.id) {
            ...
            this.error.set();
            transport.getPublisherUI(
                this.data.id,
                function (err, type, content) {
